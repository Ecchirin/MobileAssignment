...
public class SampleEntity implements EntityBase, Collidable
{
        ...
        public void Init(SurfaceView _view) {
                bmp[0] = BitmapFactory.decodeResource(_view.getResources(), R.drawable.plasticbottle);
                bmp[1] = BitmapFactory.decodeResource(_view.getResources(), R.drawable.plasticbottle2);
                bmp[2] = BitmapFactory.decodeResource(_view.getResources(), R.drawable.plasticbottle3);
        ...
        {
                if(_other.GetType() == "PlasticBin")
                {
                        SetIsDone(true);
                        //Add Score
                        SampleGame.Instance.gotRight();
                }
                else if(_other.GetType() == "MetalBin")
                {
                        SetIsDone(true);
                        //Minus Score
