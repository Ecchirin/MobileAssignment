...
public class PlasticBin implements EntityBase, Collidable
{
    ...
    public void Init(SurfaceView _view) {
        bmp[0] = BitmapFactory.decodeResource(_view.getResources(), R.drawable.plastic_bin);
    ...
    public static  PlasticBin Create(int posx, int posy)
    {

        PlasticBin result = new PlasticBin();
        result.xPos = posx;
        result.yPos = posy;
